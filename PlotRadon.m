...
plot([-trough.max_val, max(min_line)], [trough.rad_pos, trough.rad_pos], '--','Color',oran,'LineWidth',1)
end
...
plot([trough.angle, trough.angle], [-trough.max_val, max(min_line)], '--','Color',oran,'LineWidth',1)
end
